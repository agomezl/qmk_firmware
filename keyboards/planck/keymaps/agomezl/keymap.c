...
[BASE] = LAYOUT_planck_grid(
        ...
        KC_LOCK, _______, KC_LGUI, KC_LALT, MO_MOVE, KC_SPC,  KC_SPC,  OSL_NUM, KC_QUOT, KC_GRV,  MO(SYM), RUN_M1
),
...
[MOVE] = LAYOUT_planck_grid(
        ...
        _______, _______, E_MAGIT, _______, _______, HOL_R,   HOL_R,   KC_LCTL, _______, _______, _______, HOL_TRM
),
